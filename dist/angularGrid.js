                ...
                for(var i = 0; i < cols.length; i++){
                    ...
                    if(config){
                        if(config.SetFilter && createdFilter.filter.model && createdFilter.filter.model.selectNothing){
                            ...
                            var unwatch = createdFilter.filter.$scope.$watch(function(newVal){
